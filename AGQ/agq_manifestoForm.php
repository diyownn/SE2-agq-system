    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-sm-offset-4 col-sm-4" id="border1">
                ...
                <form action="agq_manifestoForm.php" method="POST" class="form-content" enctype="multipart/form-data" onsubmit="return validate_otImg()">
...
<?php
 ...
 if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['manPic']['tmp_name'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_document (DocumentID, Document_type, Document_picture) VALUES (?, ?, ?)");
    if (!$stmt) {
        die("Preparation failed: " . $conn->error);
    }


    $stmt->bind_param("ssb", $refNum, $type, $man_docs);
